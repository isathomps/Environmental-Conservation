...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3403',
            //extent: [-119.894419, 49.011823, 5229748.674286, 6666888.764586],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-597280.959355, 5376724.749236, 927689.570047, 6654611.446026], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Isabel Thompson - Lab2 Env Conservation - GGR273</h2>';
        return titleElement;
    })(),
